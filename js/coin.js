...
(function () {
	...
	coinjs.host = ('https:'==document.location.protocol?'https://':'http://')+'chainz.cryptoid.info/ion/api.dws/';
	coinjs.uid = '1';
	coinjs.key = '69c9044291c9';
	...
	*/
	...
	coinjs.addressBalance = function(address, callback){
		coinjs.ajax(coinjs.host+'?uid='+coinjs.uid+'&key='+coinjs.key+'&q=getbalance&address='+address+'&r='+Math.random(), callback, "GET");
	}
